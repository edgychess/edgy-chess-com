...
exports.config ={
	...
	"model":{
		"title-en":"Edgy Chess",
		"summary":"Chess along the edges by Edge Bernard (2017)",
		"thumbnail":"edgy-chess-thumb.png",
		"module":"chessbase",
		"plazza":"true",
		"released": 1501545600, // 2017-08-01
		"rules":{
			"en":"../../../../rules.html"
		},
		"credits":{
	...
	"view":{
		...
		"visuals":{
			"600x600":[
				"edgy-chess-600x600-3d.jpg",
				"edgy-chess-600x600-2d.jpg"
			]
		},
		"xdView":true,
		"css":[
		...
		"skins":[
			{
				...
				"camera":{
					...
					"distMax":50,
					"radius":18,
					"elevationAngle":45, //60
					"elevationMin":0,
					"rotationAngle": 135 //90
				}
			},
			{
				"name":"skin3dflat",
